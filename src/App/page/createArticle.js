...
import { createRecord, findType, addType } from '../api/index';
          ...
          <section className="bg-f5f5f5  padding-all ">
            ...
            <Row justify="center">
                ...
                {dataMap&&dataMap.length>0 ? dataMap.map((itm, idx)=>{
                    ...
                    <Col className="text-align-right" > { idx==0 ? '' :  <Icon iconName={'trash-a'} size={'150%'} iconColor={'#6E9EFB'} onClick={()=>{self.deleteArr(itm, idx)}}  />  }</Col>
                    <Col><Row className="border-bottom border-color-f5f5f5">
                        <Col span={2.5} className="line-height-3r">
                            <Icon iconName={'outlet'} size={'150%'} iconColor={'#6E9EFB'}  />
                        </Col>
                        <Col span={21.5} className="padding-top-3">
                            <TagRadio options={tagTypeArr}
                            checkStyle={{"backgroundColor":"#6E9EFB","color": '#fff','borderRadius': '0.5rem'}} normalStyle={{"backgroundColor":"#eee","color": '#1a1a1a','borderRadius': '0.5rem'}}
                            onChange={(v, it)=>{
                              console.log(it)
                    ...
                    <Row className="border-bottom border-color-f5f5f5">
                        <Col span={2.5} className="line-height-3r">
                            <Icon iconName={'ios-time '} size={'150%'} iconColor={'#6E9EFB'}  />
                        </Col>
                    ...
                    <Row className="">
                        <Col span={2.5} className="line-height-3r">
                        <Icon iconName={'compose'} size={'150%'} iconColor={'#6E9EFB'}  />
                        </Col>
                ...
                <Col><Icon iconName={'android-add '} size={'150%'} iconColor={'#6E9EFB'}  /> 新增</Col>
                </Row>
              </Col>
